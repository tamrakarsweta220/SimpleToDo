...
//            Log.i("Sweta", "User clicked on button")
//        }

        loadItems()

        //Look up the recylcerview in the layout
        ...
        findViewById<Button>(R.id.button).setOnClickListener{
            //1. Grab the text the user has inputer into @id/addTaskField
            val userInputedTask = inputTextField.text.toString()

            //2. Add the string to our list of tasks: ListOfTasks
            listOfTasks.add(userInputedTask)
